...
To prepare for the course, please download R and RStudio from <https://posit.co/download/rstudio-desktop/> and then
...
While it is possible to work with another IDE, we recommend to use RStudio.

In principle, hands-on assignments may also be tackled in Python instead of R. 
However, solutions will only be supplied in R.
